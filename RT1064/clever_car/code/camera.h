#ifndef _code_camera_h
#define _code_camera_h
...
void Element_Test1(void);            //元素识别
void Element_Test2(void);            //元素识别
void Element_Test3(void);            //元素识别
...
void Handle_Barn_in1(uint8 type);   //处理入库
extern int8 pass_barn;
extern int16 close_check_ku_s;
extern int32 jinku_s;
/**************************元素处理部分结束**********************************************************************************************/
